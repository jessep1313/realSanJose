  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // ⭐ HEADER REUTILIZABLE (sin título, solo logo y notificaciones)
            const CustomHeader(),
            const SizedBox(height: 10),

            // Texto del día seleccionado
            Text(
              DateFormat('EEEE dd MMMM yyyy', lang == 'es' ? 'es_ES' : 'en_US')
                  .format(selectedDate),
